        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 w-full">
          <div className="max-w-4xl">
            ...
            <h1 className="text-5xl lg:text-9xl font-[900] text-murzak-navy dark:text-white mb-10 tracking-tighter leading-[0.85] drop-shadow-2xl">
              Privacy <br /><span className="text-murzak-cyan">protocol.</span>
            </h1>
            <p className="text-xl lg:text-3xl text-slate-700 dark:text-slate-300 font-bold max-w-2xl opacity-90">
      ...
      <section className="relative py-20 lg:py-32 bg-white/80 dark:bg-murzak-deep/80 backdrop-blur-xl">
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          <div className="prose dark:prose-invert prose-slate max-w-none space-y-20">
            <div className="bg-slate-50 dark:bg-white/5 p-10 lg:p-14 rounded-[3rem] border border-slate-100 dark:border-white/5 flex flex-col md:flex-row gap-10 shadow-xl">
              <ShieldCheck size={48} className="text-murzak-cyan flex-shrink-0" />
              <div>
                <h3 className="text-2xl font-black mb-4 tracking-tight text-murzak-navy dark:text-white">Data sovereignty commitment</h3>
                <p className="text-base text-slate-600 dark:text-slate-400 font-medium leading-relaxed">Murzak Technologies Limited is committed to the protection of business and personal data as per the <span className="text-murzak-navy dark:text-white font-bold">Kenya Data Protection Act 2019</span>. We ensure all regional client data hosted on Murzak Cloud remains within secure architectural bounds.</p>
              </div>
            </div>

            <div className="space-y-8">
              <h2 className="text-3xl font-black flex items-center gap-4 text-murzak-navy dark:text-white tracking-tighter">
                <Database size={28} className="text-murzak-cyan" /> 1. Information we collect
              </h2>
              ...
              <ul className="list-disc pl-8 space-y-4 text-slate-500 dark:text-slate-400 font-bold">
                <li><strong className="text-murzak-navy dark:text-white">Contact information:</strong> Name, work email, phone number, and company details via our contact and CRM sync forms.</li>
                <li><strong className="text-murzak-navy dark:text-white">Project data:</strong> Technical requirements, business workflows, and infrastructure preferences shared during consultations.</li>
                <li><strong className="text-murzak-navy dark:text-white">Usage metrics:</strong> Anonymous data on how you interact with our website to improve user experience.</li>
              </ul>
            </div>

            <div className="bg-murzak-navy text-white p-12 lg:p-20 rounded-[4rem] mt-24 shadow-2xl relative overflow-hidden">
              <div className="flex items-center gap-6 mb-10">
                <FileText size={32} className="text-murzak-cyan" />
                <h3 className="text-2xl font-black tracking-tighter">Compliance inquiries</h3>
              </div>
              <p className="text-base text-slate-400 font-bold mb-10 leading-relaxed">
              ...
              <p className="text-2xl font-black text-murzak-cyan tracking-tight">murzaktechnologies@gmail.com</p>
            </div>
          </div>
        </div>
      </section>
