        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 w-full">
          <div className="max-w-4xl">
            ...
            <h1 className="text-5xl lg:text-9xl font-[900] text-murzak-navy dark:text-white mb-10 tracking-tighter leading-[0.85] drop-shadow-2xl">
              Service <br /><span className="text-murzak-cyan">terms.</span>
            </h1>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          <div className="prose dark:prose-invert prose-slate max-w-none space-y-20">
            <div className="bg-slate-50 dark:bg-white/5 p-10 lg:p-14 rounded-[3rem] border border-slate-100 dark:border-white/5 flex flex-col md:flex-row gap-10 shadow-xl">
              <Scale size={48} className="text-murzak-cyan flex-shrink-0" />
              <div>
                <h3 className="text-2xl font-black mb-4 tracking-tight text-murzak-navy dark:text-white">Operating principles</h3>
            ...
            <div className="space-y-8">
              <h2 className="text-3xl font-black flex items-center gap-4 text-murzak-navy dark:text-white tracking-tighter">
                <Briefcase size={28} className="text-murzak-cyan" /> 1. Custom software ownership
              </h2>
            ...
            <div className="space-y-8">
              <h2 className="text-3xl font-black flex items-center gap-4 text-murzak-navy dark:text-white tracking-tighter">
                <CreditCard size={28} className="text-murzak-cyan" /> 2. Payment & currency
              </h2>
              <p className="text-slate-600 dark:text-slate-400 font-bold leading-relaxed">
                All services are invoiced in <strong className="text-murzak-navy dark:text-white">Kenya Shillings (KES)</strong> unless otherwise agreed. Monthly subscriptions for Murzak Cloud are billed in advance. Late payments exceeding 15 days may result in temporary service suspension.
              </p>
            </div>
          </div>
        </div>
