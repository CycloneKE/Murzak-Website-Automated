    ...
    <main className="text-white overflow-x-hidden">
      <section className="relative pt-20 lg:pt-28 pb-16 overflow-hidden">
        <div className="max-w-[1100px] mx-auto px-6 sm:px-10 lg:px-16 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-murzak-cyan/10 border border-murzak-cyan/20 mb-6">
            <span className="text-[10px] font-black uppercase tracking-widest text-murzak-cyan">For Retail & Shops</span>
          </div>
      ...
      <Section className="border-t border-white/5">
        <div className="max-w-2xl mx-auto text-center mb-12">
           ...
           <p className="text-slate-400 font-medium mb-8">Integrated tools designed for Kenyan retail workflows.</p>
        </div>
      ...
      <section className="relative py-24 overflow-hidden border-t border-white/5">
        ...
        <div className="max-w-2xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-[900] tracking-tight text-white mb-6">Ready to upgrade your counters?</h2>
          <p className="text-slate-300 font-medium mb-8">POS starting from {formatKes(serviceMonthlyKes('biz-pos-inventory'))}/mo with full inventory features.</p>
