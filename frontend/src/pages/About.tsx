    ...
    <main className="text-white overflow-x-hidden">
        ...
        <div className="max-w-[1100px] mx-auto px-6 sm:px-10 lg:px-16">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-px rounded-3xl overflow-hidden border border-white/10 bg-white/5">
            {[
              ...
              <div key={s.label} className="bg-murzak-deep/40 p-6 lg:p-8">
                <div className="text-2xl lg:text-3xl font-[900] text-murzak-gradient tracking-tight">{s.big}</div>
                <div className="font-mono text-[10px] uppercase tracking-widest text-slate-400 mt-1">{s.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 lg:py-24 border-t border-white/5">
        <div className="max-w-[1100px] mx-auto px-6 sm:px-10 lg:px-16 grid lg:grid-cols-[1fr_1.2fr] gap-12 items-start">
          ...
          <div className="space-y-5 text-slate-300 font-medium leading-relaxed text-[15px]">
            <p>
          ...
          <div className="grid sm:grid-cols-3 gap-5">
            {[
              ...
              <button key={c.t} onClick={() => onNavigate(c.page)} className="group text-left rounded-3xl border border-white/10 bg-murzak-navy/80 backdrop-blur-md p-7 transition-all hover:border-murzak-cyan/40 hover:bg-white/[0.05]">
                ...
                <span className="inline-flex items-center gap-2 font-black text-[10px] uppercase tracking-widest text-murzak-cyan group-hover:gap-3 transition-all">{c.cta} <ArrowUpRight size={14} /></span>
              </button>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-[1100px] mx-auto px-6 sm:px-10 lg:px-16">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="mt-5 text-slate-300 font-medium leading-relaxed max-w-md">
            ...
            <div className="rounded-[2.5rem] border border-white/10 bg-murzak-navy/80 backdrop-blur-md p-8 sm:p-10 space-y-7">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href={`mailto:${SUPPORT_EMAIL}`} className="text-sm font-black text-white hover:text-murzak-cyan transition break-all">{SUPPORT_EMAIL}</a>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-black text-white">Nairobi, Kenya</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-black text-white">Mon–Fri · 8:00–18:00 EAT</p>
                </div>
              </div>
            </div>
          </div>
