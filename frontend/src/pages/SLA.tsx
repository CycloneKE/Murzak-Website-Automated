        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          <div className="space-y-24">
            ...
            <div className="space-y-10">
              <h2 className="text-3xl font-black flex items-center gap-4 text-murzak-ink tracking-tighter leading-none">
              ...
              <div className="overflow-x-auto rounded-[2rem] border border-slate-100 dark:border-murzak-border/50 shadow-lg bg-white/40 dark:bg-black/20">
                <table className="w-full text-left text-sm font-bold">
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-white/10 text-slate-600 dark:text-slate-600">
                    <tr className="hover:bg-murzak-accent/5 transition-colors">
                      <td className="py-6 px-8 font-black text-murzak-ink">P1: Critical outage</td>
                      <td className="py-6 px-8">2 Hours</td>
                      <td className="py-6 px-8 text-murzak-accent">1 Hour</td>
                    </tr>
                    <tr className="hover:bg-murzak-accent/5 transition-colors">
                      <td className="py-6 px-8 font-black text-murzak-ink">P2: Major slowdown</td>
